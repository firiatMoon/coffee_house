package com.capybara.constants;
...
public class TelegramBotConstant {
    ...
    public static final String ASK_PHONE = "Please enter 10 digits of your phone without country code";
    public static final String ASK_VALIDITY_EMAIL = "Please enter a valid email address";
    public static final String ASK_VALIDITY_PHONE = "Please enter a valid phone number";
    ...
    public static final String PHONE_ALREADY_EXISTS ="This phone number is already in use. Please enter a different phone number";
    ...
    public static final String BONUSES_ARE_NOT_AVAILABLE_MESSAGE = "Bonuses can only be viewed by registered users.";
}
